...
def parse_args():
    ...
    p.add_argument("--in-dir", default="Seg_output", help="输入根目录")
    p.add_argument("--out-dir", default="Seg_output_fixed", help="输出根目录（将镜像结构）")
    ...
    p.add_argument("--max-comp", type=int, default=50, help="允许的有效连通域数量上限（独立判据）")
